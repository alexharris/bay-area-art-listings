...
export default function MobileViewToggleBar({ activeView, setActiveView }) {
    ...
    return (
        <div className="lg:hidden fixed inset-x-0 top-12 z-40 bg-white border-b border-gray-300">
            <div className="flex items-stretch h-10">
                <button
                    onClick={() => setActiveView('exhibitions')}
                    className={`flex-1 flex items-center justify-center gap-1.5 text-sm transition-colors border-r border-b border-gray-300 ${activeView === 'exhibitions' ? activeClass : inactiveClass}`}
                >
                ...
                <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-1.5 text-sm transition-colors border-r border-b border-gray-300 ${activeView === 'events' ? activeClass : inactiveClass}`}
                >
                ...
                <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-1.5 text-sm transition-colors border-b border-gray-300 ${activeView === 'map' ? activeClass : inactiveClass}`}
                >
