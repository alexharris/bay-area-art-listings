    ...
    <div className={`${isMobile ? '' : 'bg-gray-50 rounded p-4'} flex flex-col gap-3`}>
      {item.locationName.toLowerCase() === 'various'
        ...
        : <>
            ...
            <div className={`${venueOpen[index] ? 'flex' : 'hidden'} md:flex flex-col gap-2`}>
    ...
    <ul id="list-view" className="w-full px-3 md:p-2 lg:px-4">
      {listings.map((item, index) => (
        <li className="border-b min-h-40 border-dashed border-gray-400 py-5 w-full relative flex flex-col md:flex-row justify-between gap-4" key={item._id || index}>
          ...
          <div className="flex flex-col md:flex-row lg:flex-row gap-4 w-full md:w-2/3">
          ...
          <div className="flex flex-col md:flex-row lg:flex-col xl:flex-row gap-4 w-full md:w-auto lg:w-1/2">

            {/* Date section */}
            <div className="flex flex-col gap-3 w-full text-left items-start justify-start">
