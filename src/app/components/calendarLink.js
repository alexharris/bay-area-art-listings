...
export default function calendarLink(data) {
    ...
    return (
        <>
            <svg onClick={() => setIsModalOpen(true)}  className="icon-link absolute top-4 right-0" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#000000" strokeWidth="1.5" strokeLinecap="butt" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
            
            {isModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-75 z-30" onClick={() => setIsModalOpen(false)}>
                    <div className="bg-white p-4 rounded shadow-lg w-1/2 flex flex-col relative z-10" onClick={(e) => e.stopPropagation()}>
